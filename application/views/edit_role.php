   ...
   <?php $this->load->view('header');?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Edit_Role'); ?></h1>
			...
			<a href="<?php echo base_url('role/role');?>"><button type="button" class="btn btn-success">Back</button></a>
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="tab-content mt-0">
							...
							<?php foreach ($admission_view_edit as $row) {?>
                                <div class="body mt-2">
								<form action="<?php echo site_url('role/update_role')?>" method="POST">
                                    <div class="row clearfix">
									
                                                <input type="hidden" name="id" class="form-control" value="<?php echo $row['role_id']?>">
                                          
                                        <div class=" col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="role_name" class="form-control" placeholder="Role Name" value="<?php echo $row['role_name']?>">
                                            </div>
                                        </div>
