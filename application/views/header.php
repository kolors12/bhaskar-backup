 <nav class="navbar top-navbar">
        <div class="container-fluid">
            ...
            <div class="navbar-right">
                <div id="navbar-menu">
                    <ul class="nav navbar-nav">
                        <li><a href="javascript:void(0);" class="search_toggle icon-menu" title="Search Result"><i class="fa fa-search" aria-hidden="true"></i></a></li>
                        <!--li><a href="javascript:void(0);" class="right_toggle icon-menu" title="Right Menu"><i class="fa fa-comments-o" aria-hidden="true"></i><span class="notification-dot bg-pink">2</span></a></li-->
                        <li><a href="<?php echo base_url('login/logout');?>" class="icon-menu"><i class="fa fa-sign-out" aria-hidden="true"></i></a></li>
                    </ul>
                </div>
            </div>
        </div>
