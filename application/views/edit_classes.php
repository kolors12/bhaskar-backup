   ...
   <?php $this->load->view('header');?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Edit_Classes'); ?></h1>
			...
			<a href="<?php echo base_url('classes/class_view');?>"><button type="button" class="btn btn-success">Back</button></a>
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="tab-content mt-0">
							...
							<?php foreach ($classes_edit as $row) {?>
                                <div class="body mt-2">
								<form action="<?php echo site_url('classes/update_class')?>" method="POST">
                                    <div class="row clearfix">
									
                                          <input type="hidden" name="id" class="form-control" value="<?php echo $row['class_id']?>">
                                          
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="class_name" class="form-control" placeholder="Class Name" value="<?php echo $row['class_name']?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="class_grade" class="form-control" placeholder="Class Name" value="<?php echo $row['class_grade']?>">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
