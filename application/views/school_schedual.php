            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('School_schedual'); ?></h1>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Users"><?php  echo $this->lang->line('List_of_School_schedual'); ?></a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addUser"><?php  echo $this->lang->line('Add_School_schedual'); ?></a></li>        
                        </ul>
                        <div id="loading">
                        </div>
                        <div class="tab-content mt-0">
                            <div class="tab-pane show active" id="Users">
								...
								<div class="row clearfix">
                                    ...
                                    <!--input type="text"   id="teacher_name" class="form-control" placeholder="Class Name" style="background-color: #fff; border-color: #fff;" required/-->
                                    <select class="form-control show-tick" id="class_id" name="class" style="background-color: #fff; border-color: #fff;" required>
                            ...
                            <div class="tab-pane" id="addUser">
                                <div class="body mt-2">
								<h5><?php  echo $this->lang->line('Add_School_schedual'); ?></h5>
								<form   class="form-horizontal" id="form" action="<?php echo base_url('school_schedual/insert_school_schedual')?>"  method="post">
                                    <div class="row clearfix">
...
<script>
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>school_schedual/fetch_data/"+page,
                method:"POST",
                dataType:"JSON",
                data:{action:action, class_id:class_id, schedual_day:schedual_day},
