            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Edit_Teacher_Schedual'); ?></h1>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="tab-content mt-0">
							...
							<?php foreach ($edit_teacher_sch as $row) {?>
                                <div class="body mt-2">
								<form id ="form" action="<?php echo site_url('teacher_schedual/update_teacher_schedual')?>" method="POST">
                                    <div class="row clearfix">
									
                                          <input type="hidden" name="id" class="form-control" value="<?php echo $row['tech_sch_id']?>">
                                          
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                        <strong><?php  echo $this->lang->line('Teacher_Name'); ?> :-</strong>
                                            <div class="form-group">
                                                <input type="text" name="teacher_name" class="form-control" placeholder="<?php  echo $this->lang->line('Teacher_Name'); ?>" value="<?php echo $row['teacher_name']?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                       ...
                                       <strong><?php  echo $this->lang->line('Class_Name'); ?> :</strong>
                                          <div class="form-group">
                                           <input type="text" name="class" class="form-control" placeholder="<?php  echo $this->lang->line('Class_Name'); ?>" value="<?php echo $row['class']?>" readonly >
                                         </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
