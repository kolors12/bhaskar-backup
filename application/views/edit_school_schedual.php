   ...
   <?php $this->load->view('header');?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Edit_Class_Schedual'); ?></h1>
            ...
            <a href="<?php echo base_url('class_schedual/class_schedual_view');?>"><button type="button" class="btn btn-success">Back</button></a>
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="tab-content mt-0">
							...
							<?php foreach ($classes_edit as $row) {?>
                                <div class="body mt-2">
								<form id ="form" action="<?php echo site_url('class_schedual/update_class_schedual')?>" method="POST">
                                    <div class="row clearfix">
									
                                          <input type="hidden" name="id" class="form-control" value="<?php echo $row['cls_sch_id']?>">
                                       ...
                                       <strong><?php  echo $this->lang->line('Lesson_Name'); ?> :</strong>
                                          <div class="form-group">
                                           <input type="text" name="lesson_name" class="form-control" placeholder="<?php  echo $this->lang->line('Lesson_Name'); ?>" value="<?php echo $row['lesson_name']?> ">
                                         </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12">
