   ...
   <?php $this->load->view('header');?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Edit_Subjects'); ?></h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                            <!--li class="breadcrumb-item"><a href="#">Oculux</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><strong>Edit Subject</strong></li-->
                            </ol>
                        </nav>
                    </div>            
			...
			<a href="<?php echo base_url('subject/subject');?>"><button type="button" class="btn btn-success">Back</button></a>
            <div class="row clearfix">
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="tab-content mt-0">
							...
							<?php foreach ($subject_edit as $row) {?>
                                <div class="body mt-2">
								<form action="<?php echo site_url('subject/update_subject')?>" method="POST">
                                    <div class="row clearfix">
									
                                                <input type="hidden" name="id" class="form-control" value="<?php echo $row['subject_id']?>">
                                          
                                        <div class=" col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="subject_name" class="form-control" placeholder="Subject Name" value="<?php echo $row['subject_name']?>">
                                            </div>
                                        </div>
