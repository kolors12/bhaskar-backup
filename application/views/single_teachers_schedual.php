                    ...
                    <div class="card">
                        ...
                        <div class="tab-content mt-0">
                            ...
                            <div class="tab-pane" id="addUser">
                                <div class="body mt-2">
								<form   class="form-horizontal" id="form" action="<?php echo base_url('single_teacher_schedual/insert_teacher_schedual')?>"  method="post">
                                    <div class="row clearfix">
...
<script>
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>single_teacher_schedual/fetch_data/"+page,
                method:"POST",
                dataType:"JSON",
