            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Subjects'); ?></h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                            <!--li class="breadcrumb-item"><a href="#">Oculux</a></li>
                            <li class="breadcrumb-item active" aria-current="page"><strong>Subjects</strong></li-->
                            </ol>
                        </nav>
                    </div>            
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Users"><?php  echo $this->lang->line('List_of_Subjects'); ?></a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addUser"><?php  echo $this->lang->line('Add_Subject'); ?></a></li>        
                        </ul>
                        <div id="loading">
                        </div>
                        <div class="tab-content mt-0">
                            <div class="tab-pane show active" id="Users">
								...
								<div class="row clearfix">
                                    ...
                                    <input type="text"   id="subject_name" class="form-control" placeholder="<?php  echo $this->lang->line('Subject_Name');?>" style="background-color: #fff; border-color: #fff;" required/>
									</div>
									</div>
                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        <thead>
                                            <tr>
												...
												<th><?php  echo $this->lang->line('Subject_Status');?></th>
                            ...
                            <div class="tab-pane" id="addUser">
                                <div class="body mt-2">
								<h5><?php  echo $this->lang->line('Add_Subject');?></h5>
								<form   class="form-horizontal" id="form" action="<?php echo base_url('subject/insert_subject')?>"  method="post">
                                    <div class="row clearfix">
									
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="subject_name" class="form-control " placeholder="<?php  echo $this->lang->line('Subject_Name');?>" required>
											</div>
                                        </div>
...
<script>
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>subject/fetch_data/"+page,
                method:"POST",
                dataType:"JSON",
                data:{action:action, subject_name:subject_name},
