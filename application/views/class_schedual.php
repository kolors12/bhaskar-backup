            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Class_schedual'); ?></h1>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Users"><?php  echo $this->lang->line('List_of_Class_schedual'); ?></a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addUser"><?php  echo $this->lang->line('Add_Class_schedual'); ?></a></li>        
                        </ul>
                        <div id="loading">
                        </div>
                        <div class="tab-content mt-0">
                            <div class="tab-pane show active" id="Users">
								...
								<div class="row clearfix">
                                    ...
                                    <input type="text"   id="lesson_name" class="form-control" placeholder="<?php  echo $this->lang->line('Lesson_Name'); ?>" style="background-color: #fff; border-color: #fff;" required/>
									</div>
                                    </div>
								    <div class="col-lg-3">
									<div class="form-group" style="margin-top:20px;">
                                    <!--input type="text"   id="subject" class="form-control" placeholder="Lesson Name" style="background-color: #fff; border-color: #fff;" required/-->
                            ...
                            <div class="tab-pane" id="addUser">
								...
								<form   class="form-horizontal" id="form" action="<?php echo base_url('class_schedual/insert_school_schedual')?>"  method="post">
                                    <div class="row clearfix">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12">
										<strong><?php  echo $this->lang->line('Lesson_Name'); ?> :</strong>
                                            <div class="form-group">
                                                <input type="text" name="lesson_name"  class="form-control " placeholder="<?php  echo $this->lang->line('Lesson_Name'); ?>" required>
											</div>
                                        </div>
									   ...
									   <strong><?php  echo $this->lang->line('Class_and_Grade'); ?> :</strong>
										...
										<strong> <?php  echo $this->lang->line('To_Time'); ?> :</strong>
                                            <div class="form-group">
                                                <input type="time" name="to_time"  class="form-control " placeholder="To Time" required>
											</div>
                                        </div>
										<div class="col-lg-6 col-md-6 col-sm-12">
										<strong><?php  echo $this->lang->line('From_Time'); ?> :</strong>
                                            <div class="form-group">
                                                <input type="time" name="from_time"  class="form-control " placeholder="From Time" required>
											</div>
                                        </div>
...
<script>
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>class_schedual/fetch_data/"+page,
                method:"POST",
                dataType:"JSON",
                data:{action:action, class_id:class_id, lesson_name:lesson_name,schedual_day:schedual_day},
