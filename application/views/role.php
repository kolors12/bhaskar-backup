            ...
            <div class="block-header">
                <div class="row clearfix">
                    <div class="col-md-6 col-sm-12">
                        <h1><?php  echo $this->lang->line('Roles'); ?></h1>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <ul class="nav nav-tabs">
                            <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#Users"><?php  echo $this->lang->line('List_of_Roles'); ?></a></li>
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#addUser"><?php  echo $this->lang->line('Add_Role'); ?></a></li>        
                        </ul>
                        <div id="loading">
                        </div>
                        <div class="tab-content mt-0">
                            <div class="tab-pane show active" id="Users">
								...
								<div class="row clearfix">
                                    ...
                                    <input type="text"   id="role_name" class="form-control" placeholder="<?php  echo $this->lang->line('Role_Name'); ?>" style="background-color: #fff; border-color: #fff;" required/>
									</div>
									</div>
                                    ...
                                    <table class="table table-hover table-custom spacing8">
                                        <thead>
                                            <tr>
                                                ...
                                                <th><?php  echo $this->lang->line('Role_Status'); ?></th>
                            ...
                            <div class="tab-pane" id="addUser">
                                <div class="body mt-2">
								<h5><?php  echo $this->lang->line('Add_Role'); ?></h5>
								<form   class="form-horizontal" id="form" action="<?php echo base_url('role/insert_role')?>"  method="post">
                                    <div class="row clearfix">
									
                                        <div class="col-lg-6 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                <input type="text" name="role_name" class="form-control " placeholder="<?php  echo $this->lang->line('Role_Name'); ?>" required>
											</div>
                                        </div>
...
<script>
    $(document).ready(function(){
        ...
        function filter_data(page)
        {
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>role/fetch_data/"+page,
                method:"POST",
                dataType:"JSON",
                data:{action:action, role_name:role_name},
